...
import Asynchronous from "../../../../layouts/public/AutoComplete";
import MyForm from "../../../../components/AutoCompleteProduct";

const AddProductPromotionForm = (props, disabled) => {
  ...
  return (
    <Box sx={{ mx: 2 }}>
      {formLoading ? (
        ...
        //   </Stack>
        // </form>
        <MyForm onClick={onClick} />
      )}
    </Box>
  );
};

export default AddProductPromotionForm;
