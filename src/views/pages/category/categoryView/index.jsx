...
import { viewCategoryData } from "redux/api/services/categoryService";

const CategoryView = () => {

    let { id } = useParams();
    const dispatch = useDispatch()
    const categoryviewData = useSelector((state) => state.category.viewCategory)
    ...
    return (
        <Box className="indexBox">
            <TopBreaccrumb title={"Category List"} to={`/category`} />
            <Grid
                container
                spacing={2}
                sx={{ my: 4 }}
                            ...
                            <Grid container>
                                <Grid item xs={12} sm={5} md={5}>
                                    <Box className="viewLeftSide">
                                        <Typography sx={{ py: 2,color:"white" }}>Category Name</Typography>
                                    </Box>
                                </Grid>
                            ...
                            <Grid container>
                                ...
                                <Grid item xs={12} sm={7} md={7}>
                                    <Box className="viewRightSide">
                                        <Typography sx={{ py: 2,color:"white" }}>
                                            {!categoryviewData?.loading ? (
                                                categoryviewData?.data?.data?.parent_id
                                            ) : (
                                                <Skeleton variant="text" sx={{ fontSize: "1rem" }} />
                                            )}
                                        </Typography>
